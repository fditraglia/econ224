...
6. Based on your results from question 5, for which value of `hsize` would we predict the *highest* SAT score?
...
2. Use your function to plot the K-nearest neighbors regression curve predicting `mpg` from `dist` in the `mtcars` dataset along with the raw data for each variable.
