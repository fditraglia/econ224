...
$$\underbrace{E[Y_i|D_i=1] - E[Y_i|D_i=0]}_{\mbox{Observed Difference}} = \underbrace{E[Y_{1i}|D_i=1] - E[Y_{0i}|D_i=1]}_{\mbox{Treatment on the Treated}} + \underbrace{E[Y_{0i}|D_i=1] - E[Y_{0i}|D_i=1]}_{\mbox{Selection Bias}}$$
