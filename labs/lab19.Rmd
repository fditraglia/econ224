...
summary(lm(wage_st ~ low_wage + post + low_wage:post, nj_only))
summary(lm(fte ~ low_wage + post + low_wage:post, nj_only))
summary(lm(wage_st ~ low_wage + post + low_wage:post, pa_only))
summary(lm(fte ~ low_wage + post + low_wage:post, pa_only))
```
