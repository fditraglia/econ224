...
```{r}
knitr::opts_chunk$set(comment=NA, fig.width=3.5, fig.height=3.5, fig.align = 'center')
```
...
While we've seen a number of examples, I haven't yet spent any time clarifying the syntax of `ggplot`.
