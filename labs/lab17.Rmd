...
# RD Analysis in R 
To understand how to carry out RD analysis in R, we first need to review some regression basics from Econ 103. 
...
2. Simulate 500 observations from the regression model from part 1. Generate $X$ from a Uniform$(0,1)$ distribution and and the errors $\epsilon$ from a $N(0,\sigma^2)$ distribution. Choose values of the parameters in your simulation that imply visibly different slopes and intercepts for males and females and an error variance that is small enough that these differences are visible in the data.
...
2. Simulate 500 observations from the regression model from part 1. Generate $X$ from a Uniform$(0,1)$ distribution and and the errors $\epsilon$ from a $N(0,\sigma^2)$ distribution. Choose values of the parameters in your simulation that imply visibly different slopes and intercepts to the left and right of the cutoff $c$ and an error variance that is small enough that these differences are visible in the data.
3. Use the simulated data from part 2 to fit the regression model from part 1. Plot the raw data along with the estimated regression lines to the left and right of the cutoff. 
4. If we interpret the model in this exercise as an RD design, which coefficient gives us the estimated causal effect? What is the associated standard error? 
