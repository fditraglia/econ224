...
\caltextnext{Logistic Regression (ISL 4.1--4.3)\\ Lab 9: Logistic Regression in R}

\caltextnext{More on Classification (ISL 4.4--4.5)\\ Lab 10: Contaminated Drinking Water in Bangladesh}

\caltextnext{Final Projects (MM 3.1)}
\caltextnext{Final Projects}

\caltextnext{Instrumental Variables I  \\ Lab 11: Instrumental Variables Regression}

\caltextnext{Instrumental Variables II (MM 3.2--3.3) \\ Lab 12: Institutions and Economic Development}
 

\caltextnext{Cross-validation and the Bootstrap (ISL Ch.\ 5) \\ Lab 13: Cross-validation and Bootstrapping in R}

\caltextnext{Model Selection (ISL 6.1) \\ Lab 14: Predicting Baseball Player Salaries}

\caltextnext{Shrinkage Methods (ISL 6.2, 6.4) \\ Lab 15: Predicting Baseball Player Salaries}

\caltextnext{Tree-Based Methods (ISL 8.1 [1 \& 3], 8.2 [1 \& 2])\\ Lab 16: Predicting House Prices}
