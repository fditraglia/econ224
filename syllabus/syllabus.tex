...
Given its somewhat unusual format, you should think carefully about whether Econ 224 is the best course for you.
If you have sufficient time in your schedule  
...
You are expected to be conversant with elementary probability and statistics (e.g.\ confidence intervals, hypothesis testing, and simple linear regression) and the basics of R programming.
