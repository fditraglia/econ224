...
\caltexton{1}{Course Outline/Policies, Pre-test\\ Lab 1: Gapminder Dataset} 
...
\caltextnext{Tree-Based Methods (ISL 8.1 [1 \& 3], 8.2 [1 \& 2])\\ Lab 16: ???}
% This data is used by Mullainathan & Spiess

\caltextnext{Regression Discontinuity I (MM 4.1)\\ Lab 17: ???}

\caltextnext{Regression Discontinuity II (MM 4.2)\\ Lab 18: ???}
