...
\caltextnext{More on Classification (ISL 4.4--4.5)\\ Lab 10: Predicting Credit Card Default}
% Also simple linear discriminant analysis (p = 2)
% Imai instructor's repo: Probability chapter

\caltextnext{Instrumental Variables I (MM 3.1) \\ Lab 11: Institutions and Economic Development} 
