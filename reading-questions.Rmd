...
4. Explain the meaning of $\beta_0$ and $\beta_1$ in a logistic regression that uses a single regressor $X$ to predict the probability $p(X)$ that $Y=1$. If $X$ increases by one unit, how does $p(X)$ change?
...
## Quiz \#9: Tuesday, September 25th -- ISL 4.4-4.5
